...
public class CollisionControlSystem implements IPostEntityProcessingService {
    ...
    private void handleAsteroidCollision(Entity entityA, Entity entityB, World world) {
        if (entityA.getEntityType().equals(EntityType.ASTEROID) || entityB.getEntityType().equals(EntityType.ASTEROID)) {
    ...
    private boolean checkCollision(Entity entityA, Entity entityB) {
        if (isEntitiesSameType(entityA, entityB)) return false;
