...
/**
 * The `IPostEntityProcessingService` interface is used to describe the
 * post-processing logic for all types of entities.
 *
 * <p>
 * Implementations of this interface have to implement the `process` method,
 * which is called each game update cycle after all `IEntityProcessingServices`
 * have been processed.
 */
public interface IPostEntityProcessingService {

	/**
	 * Process game data and world entities after all `IEntityProcessingServices`
	 * have been processed.
	 *
	 * @param gameData
